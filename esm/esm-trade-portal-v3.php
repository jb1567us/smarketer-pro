    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 992px) {
            :root { --sidebar-w: 100%; --header-h: 70px; }
            ...
            aside {
                ...
                height: calc(100vh - var(--header-h)); background: var(--bg); z-index: 1000;
                transition: left 0.4s; padding: 1.5rem;
            }
            aside.active { left: 0; }
            main { padding: 1.5rem; }
            .view-header { flex-direction: column; gap: 0.5rem; margin-bottom: 2rem; }
            .view-title { font-size: 2rem; }
            #artwork-grid { grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap: 1rem; }
            .viz-body { flex-direction: column; padding: 1rem; gap: 1rem; }
            .viz-controls { width: 100%; order: 2; padding: 1.5rem; }
            .viz-canvas-area { width: 100%; height: 40vh; flex: none; order: 1; }
        }
...
<body>
        ...
        <div class="viz-body">
            ...
            <div class="viz-controls">
                ...
                <div id="viz-tab-room" style="display:none;">
                    ...
                    <div id="room-templates-container" style="margin-top:20px;">
                        <!-- Templates -->
                    </div>
                ...
                <div style="margin-top:auto; display:flex; flex-direction:column; gap:10px;">
                    <button id="btn-download-pdf" class="btn-premium outline" style="width:100%;" onclick="ESM_Visualizer.downloadPDF()">Download Scene</button>
                    <button class="btn-premium" style="width:100%; margin-top:10px;" onclick="ESM_Visualizer.close()">Select Different Art</button>
                </div>
            </div>
    ...
    <script src="<?php echo plugin_dir_url(__FILE__); ?>esm-trade-portal-v3.js?v=3.0.0"></script>
</body>
</html>
        <?php
        exit;
