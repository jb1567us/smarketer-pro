<?php
// deploy_v5_complete.php
// Restore V5 with ALL content details (Specs, Downloads)

$root = __DIR__;
$new_file = 'anemones_v5.html';
$path = $root . '/' . $new_file;
$time = date('Y-m-d H:i:s');

// 1. Full Content (Restored from DB inspection)
$html = <<<'HTML'
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <footer class="site-footer">
        &copy; 2025 Elliot Spencer Morgan - V5 Complete
    </footer>
</body>
</html>
HTML;
...
echo "✅ Updated index.php to point to v5<br>";
