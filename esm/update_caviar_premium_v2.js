...
(function () {
    console.log("Starting refined premium layout update...");

    // Read the file content - simulating reading since we are in JS environment
    // In a real environment we would bundle this, but here I will duplicate the updated HTML structure
...
<style>
    ...
    /* Media query to constrain image on very wide screens if needed, 
       but allowing it to be fullish-width on mobile/tablet */
    ...
    .details-grid {
        ...
        gap: 0; /* Removing gap for bordered look */
    }
    ...
    .detail-item:nth-child(2n) {
        border-right: none; /* No border on right column */
    }
    ...
    .detail-value {
        ...
        color: #1a1a1a;
        font-size: 1.1rem;
        font-family: 'Playfair Display', serif; /* Serif for values to contrast with sans-serif label */
    }
...
<div class="artwork-page-container">
    ...
    <div class="designer-specs-premium"
         ...
         data-style="abstract-geometric"
         data-collection="2024-collection">
        ...
        <ul class="specs-list">
            ...
            <li style="border-bottom: none; padding-top: 1rem; margin-top: 0.5rem; border-top: 1px dashed #eee;">
                ...
                <span style="font-size: 0.85rem; color: #666;">Abstract, Geometric, Blue, Oversized</span>
            </li>
        </ul>
