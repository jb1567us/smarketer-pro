<?php
// Deploy Trade Portal Fix (Critical Error Patch)
...
if (file_put_contents($file, $payload)) {
    ...
    echo "<h2>✅ Trade Portal Critical Fix Deployed</h2>";
    echo "<p>File written to: <code>$file</code></p>";
    echo "<p><a href='/trade/' target='_blank' style='display:inline-block; padding:10px 20px; background:#2ecc71; color:white; text-decoration:none; border-radius:5px;'>Open Trade Portal</a></p>";
    echo "</div>";
