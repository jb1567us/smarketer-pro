...
class WordPressPortfolioGenerator:
    ...
    def generate_homepage_content(self):
        """Generate homepage content with responsive grid - no hero section"""
        homepage_content = '''
    ...
    def generate_theme_files(self):
        """Generate complete WordPress theme with dynamic menu system"""
        # style.css - Updated with proper responsive grid system and dynamic menu support
        style_content = f"""/*
...
/* Responsive Grid System for Homepage */
.homepage-container .artwork-grid {{
    display: grid;
...
/* Responsive Grid for Category Pages */
...
/* Remove H1 from pages since content already includes headings */
...
"""
        ...
        # functions.php - Updated with dynamic menu support
...
"""
        ...
        # header.php - Updated with dynamic menu
        header_content = """<?php
/**
...
"""
        ...
        # front-page.php - Homepage template without hero
...
"""
        ...
        # page.php - Static pages without headers
        page_content = """<?php
/**
...
- Dynamic navigation menu with automatic category inclusion
- No homepage hero section
- Clean page layouts without duplicate headers
...
"""
    ...
    def run(self):
        ...
        print(f"🌐 Dynamic Menu: Automatically includes WordPress categories")
