<?php
// deploy_v4_flush.php
// Force update static + FLUSH OPCACHE

$root = __DIR__;
$new_file = 'anemones_v4.html';
$path = $root . '/' . $new_file;
$time = date('Y-m-d H:i:s');

// 1. Content (Real Data v4)
$html = <<<'HTML'
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <footer class="site-footer">
        &copy; 2025 Elliot Spencer Morgan - V4 Restored
    </footer>
</body>
</html>
HTML;
...
echo "✅ Updated index.php to point to v4<br>";
...
if (function_exists('opcache_reset')) {
    ...
    echo "⚠️ Opcache function not available.<br>";
}

// 4. Verify Readback
$check = file_get_contents($index);
if (strpos($check, 'anemones_v4.html') !== false) {
    echo "✅ Verification: index.php contains v4.<br>";
}
