...
<div class="ttp-container ttp-section">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<?php if ( trim( get_the_content() ) ) : ?>
			<div class="ttp-card ttp-card--wide" style="margin-bottom:16px;">
	...
	<div class="ttp-section__grid">
		<div class="ttp-card ttp-card--wide">
			...
			<?php if ( $puppy_title ) : ?>
				<p class="ttp-muted">You’re applying for: <strong><?php echo esc_html($puppy_title); ?></strong></p>
			<?php endif; ?>

			<?php if ( $waitlist_url ) : ?>
				<div class="ttp-embed ttp-embed--form">
					<iframe title="Waitlist form" loading="lazy" src="<?php echo esc_url($waitlist_url); ?>"></iframe>
				</div>
			<?php else : ?>
