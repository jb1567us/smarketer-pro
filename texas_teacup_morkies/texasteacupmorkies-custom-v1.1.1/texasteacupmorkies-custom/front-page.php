...
<section class="ttp-section ttp-section--alt">
	<div class="ttp-container ttp-section__grid">
		<div class="ttp-card">
		...
		<div class="ttp-card">
			...
			<hr>
			<p class="ttp-muted" style="margin:0;">Tip: if you want leads earlier, switch Lead Mode to <strong>Waitlist</strong> in TTP Settings.</p>
		</div>
	</div>
</section>
...
<section class="ttp-section">
	<div class="ttp-container">
		<div class="ttp-card">
			<h2 class="ttp-h2">Serving the Austin metro area</h2>
			<p class="ttp-muted">If you’re nearby, these pages explain the Austin pickup process and include map directions from your city center.</p>
			<div class="ttp-row" style="margin-top:10px;">
