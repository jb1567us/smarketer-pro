...
/**
 * [ttp_map_directions]
 * Directions from locality center (origin) to pickup address (destination).
 */
function ttp_sc_map_directions( $atts = array() ) {
	...
	$from = trim( (string) ( $atts['from'] ?: ttp_get_option( 'locality_center', 'Austin, TX' ) ) );
	$to   = trim( (string) ( $atts['to'] ?: ttp_get_option( 'pickup_address', '3800 Manorwood Rd, Austin, TX 78723' ) ) );
