...
<footer class="ttp-footer">
	<div class="ttp-container ttp-footer__inner">
		...
		<div>
			...
			<div class="ttp-footer__meta">
				...
				<?php if ( $phone ) : ?>
					<div><a href="<?php echo esc_url( ttp_format_phone_href($phone) ); ?>"><?php echo esc_html($phone); ?></a></div>
				<?php endif; ?>
	...
	<div class="ttp-container ttp-muted" style="padding:10px 18px 24px;font-size:13px;">
